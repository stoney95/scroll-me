...
const projects = [
    {
        data: {
            ...
            tags: ["sentiment analysis", "deep learning", "neural networks", "NLP", "EMNLP 2018"],
            scope: "NLP Research",
            role: "Researcher",
            teamSize: 4,
        },
    ...
    },
    {
        data: {
            ...
            tags: ["Time Series Forecasting", "Deep Learning", "XGBoost", "Comparative Analysis", "Research"],
    ...
    },
    {
        data: {
            ...
            tags: ["Azure Speech-to-Text", "SpaCy", "NLP", "automotive call center", "keyword extraction", "sentiment analysis"],
            scope: "Speech-to-Text, NLP",
            role: "Software Engineer, NLP Analyst",
            teamSize: 3
        },
        date: {
            year: 2019,
    ...
    },
    {
        data: {
            ...
            tags: ["Reinforcement Learning", "MCTS", "Goods Transportation", "German Railway Network", "Microsoft Germany - AI Award", "Web App", "Serverless Architecture"],
            scope: "Simulation environment development, RL algorithm implementation (MCTS), Web app development, Backend serverless architecture",
    ...
    },
    {
        data: {
            ...
            tags: ["Energy Consumption Analysis", "Data Analysis", "Data Visualization", "Optimization", "Recommendations", "Business Communication"],
            scope: "Explorative data analysis, Data visualization",
            role: "Data Analyst, Visualization Expert, Business Communicator",
            teamSize: 5
        },
        date: {
            year: 2019,
    ...
    },
    {
        data: {
            ...
            tags: ["Data Migration", "Cloud Architecture", "Business Processes", "Data Visualization", "PySpark", "KPI Calculation"],
            scope: "Data migration, Business process understanding, Data structuring and visualization, PySpark pipeline development, KPI calculation optimization",
    ...
    },
    {
        data: {
            ...
            titleShort: "Integration of AWS ACT into NLP Platform for Corporate Translations",
            ...
            tags: ["NLP Platform", "AWS Active Custom Translate (ACT)", "Translation Quality", "Evaluation", "BLEU Score", "Domain-specific Abbreviations"],
    ...
    {
        data: {
            title: "AI Initiative for Democratizing AI using Azure Machine Learning (AzureML)",
            titleShort: "AI Initiative for Democratizing AI with AzureML",
    ...
    },
    {
        data: {
            ...
            tags: ["Timeseries Forecasting", "Scalability", "Demand Planning", "AutoML", "Custom Forecasting Algorithms", "Parallelization", "Interface Design", "Team Leadership"],
            scope: "Laying out technical agenda, Discussing midterm project roadmap with customer, Defining interfaces with corporate architects, Leading team of 4 developers",
            role: "Tech Lead, Project Planner, Interface Designer, Team Leader",
            teamSize: 4
        },
        date: {
            year: 2022,
